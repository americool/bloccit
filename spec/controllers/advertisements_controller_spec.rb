...
let(:my_ad) {Advertisement.create!(title: RandomData.random_sentence,
  copy: RandomData.random_paragraph, price: rand(1..500))}
  ...
  describe "POST #create" do
    ...
    it "increases the number of Ads by 1" do
      expect{post :create, advertisement:
        {title: RandomData.random_sentence,
          copy: RandomData.random_paragraph,
          price: rand(1..500)}}.to change(Advertisement, :count).by(1)
    end

    it "assigns the new ad @advertisement" do
